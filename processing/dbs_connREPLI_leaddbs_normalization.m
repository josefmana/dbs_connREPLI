...
message = sprintf('%s: %s %s %s',date,'Normalization (with brainshift correction) of sixty-two patients took',string(sec),'(hh:mm:ss).');
...
% - Lead-DBS Job created on 23-Dec-2022 20:23:25 -
% --------------------------------------
...
options.uipatdirs = {
                     ...
                     '/Users/josefmana/Desktop/crusades/dbs_mriCONN_replicate/data/mri/IPN526'
