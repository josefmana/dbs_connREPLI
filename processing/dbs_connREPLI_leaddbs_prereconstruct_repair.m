% - Lead-DBS Job created on 07-Jan-2023 18:10:20 -
% --------------------------------------
tic % initiate timer
...
message = sprintf('%s: %s %s %s',date,'Pre-reconstruction (via PaCER) of fifteen patients took',string(sec),'(hh:mm:ss).');
...
function options = getoptslocal_medtronic_3389
    ...
    options.uipatdirs = {
                         ...
                         '/Users/josefmana/Desktop/crusades/dbs_mriCONN_replicate/data/mri/IPN243'
...
function options = getoptslocal_medtronic_B33005
    ...
    options.ecog.extractsurface.method = 1;
    options.uipatdirs = {
                         '/Users/josefmana/Desktop/crusades/dbs_mriCONN_replicate/data/mri/IPN347'
